...
export class mig1679139665905 implements MigrationInterface {
  name = 'mig1679139665905';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."user_access_level_enum" AS ENUM('user', 'moderator', 'admin')`,
    );
    await queryRunner.query(
